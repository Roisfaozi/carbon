...
- `pdf/fonts.data.ts` — **generated** `BUNDLED_FONTS` (base64 woff). Produced by
  `scripts/generate-fonts.mjs` (run `pnpm --filter @carbon/documents gen:fonts`) from
  the `@fontsource/*` devDeps (static, numeric-weight instances — NOT the variable
  packages). Committed (generated bytes, ~720 KiB base64).
